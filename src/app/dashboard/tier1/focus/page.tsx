...
import DistractionsKiller from '@/components/tier1/DistractionsKiller';
  ...
  return (
    <DashboardShell user={user}>
      <div className="space-y-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Distractions Killer</h1>
